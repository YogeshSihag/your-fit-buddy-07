...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Your Fitness Friend — AI Form Coach" },
      { name: "description", content: "AI Fitness Coach analyzes workout form via camera, recommends exercises, and tracks user progress." },
      { name: "author", content: "Your Fitness Friend" },
      { property: "og:title", content: "Your Fitness Friend — AI Form Coach" },
      { property: "og:description", content: "AI Fitness Coach analyzes workout form via camera, recommends exercises, and tracks user progress." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Your Fitness Friend — AI Form Coach" },
